...
RUN: (env "cxx_add_to_sub:$FILEPATH:6:13:6:14"=1 %s-ir.exe || true) | %filecheck %s --dump-input=fail --strict-whitespace --match-full-lines --check-prefix=STANDALONE_WITH_MUTATION
