...
FRONTEND:Recording mutation point: cxx_add_to_sub:{{.*}}/sample.cpp:6:12:6:13 (end: 6:13)
...
RUN: (env "cxx_add_to_sub:$FILEPATH:6:12:6:13"=1 %s-ir.exe || true) | %filecheck %s --dump-input=fail --strict-whitespace --match-full-lines --check-prefix=STANDALONE_WITH_MUTATION
